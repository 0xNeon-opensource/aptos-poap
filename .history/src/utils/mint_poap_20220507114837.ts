...
export async function mintPOAP() {
    ...
    await client.createCollection(root, collection_name, "Aptos POAP", "https://aptos-poap.vercel.app/claim")
    await client.createToken(root, collection_name, token_name, "Aptos Hackathon #1", 1, "https://arweave.net/C8EqQ5Qft_okdR2_eZbnrVO25YxFPP4ZhVzWjwzxpHc")
    ...
    console.log(`Users's token data: ${JSON.stringify(user_token_data)}`)
